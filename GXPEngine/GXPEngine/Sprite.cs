...
namespace GXPEngine
{
	...
	public class Sprite : GameObject
	{
        ...
        //------------------------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Gets or sets the sprite's origin in pixels.
        /// </summary>
        ...
        //														GetArea()
        //------------------------------------------------------------------------------------------------------------------------
        internal virtual float[] GetArea() {
			return new float[8] {
        ...
        //------------------------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Gets the four corners of this object as a set of 4 Vector2s. (for UI)
        /// </summary>
        /// <returns>
        /// The extents.
        /// </returns>
        public Vector2[] GetExtents2D()
        {
            Vector2[] ret = new Vector2[4];
			Vector3[] ext3d = GetExtents();
			for (int i = 0; i < 4; i++)
				ret[i] = new Vector2(ext3d[1].x, ext3d[1].y);
            return ret;
        }
